 ...
 *
 */
public class TopTaskSchedulerThreadFactory implements ThreadFactory {
	...
	public TopTaskSchedulerThreadFactory(String prefix) {
		this(prefix, null, false);
	}
	
	public TopTaskSchedulerThreadFactory(String prefix, ThreadGroup group, boolean isDaemon) {
